...
public class sending extends javax.swing.JFrame {
  ...
  JOptionPane.showMessageDialog(null, "Thank you " + " " + name.getText() + "\nTransactions performed at " + Timestamp, "Transaction was successful", JOptionPane.INFORMATION_MESSAGE);
        ...
        try {
            ...
            MessageFormat header = new MessageFormat("Crypto Exchanges");
    ...
    private void initComponents() {
        ...
        jLabel72.setText("You have to receive");
        ...
        simult.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, 370, -1));
        ...
        rc4.addInputMethodListener(new java.awt.event.InputMethodListener() {
            public void caretPositionChanged(java.awt.event.InputMethodEvent evt) {
            }
            public void inputMethodTextChanged(java.awt.event.InputMethodEvent evt) {
                rc4InputMethodTextChanged(evt);
            }
        });
        ...
        simult.add(rcc1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 24, -1, 0));

        rcout.setText("jLabel6");
        simult.add(rcout, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 54, -1, 0));
...
int y = 0;
    private void r4KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_r4KeyPressed
        ...
        if (key == 10) {
            if (!r4.getText().isEmpty()) {
                ...
                int b1 = Integer.parseInt(r4.getText(), 10);
                double c = a * b;
    ...
    private void rc4InputMethodTextChanged(java.awt.event.InputMethodEvent evt) {//GEN-FIRST:event_rc4InputMethodTextChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_rc4InputMethodTextChanged
